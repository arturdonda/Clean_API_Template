...
export const signUpService = new SignUp(userRepository, uuidService, passwordHashService, emailService);
export const updateOptionalData = new UpdateOptionalData(userRepository);
export const updatePasswordService = new UpdatePassword(userRepository, passwordHashService, emailService);
